...
{if ("" != null) return e;}
  ...
  final public Exp Semicol() throws ParseException {Exp e1,e2;
    e1 = Struct();
...
{if ("" != null) return e1;}
  ...
  final public Exp Struct() throws ParseException {Exp e;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LET:{
      e = decl();
{if ("" != null) return e;}
...
{if ("" != null) return e;}
  ...
  final public Exp ifThenElse() throws ParseException {Exp e1, e2, e3=null;
    jj_consume_token(IF);
    e1 = Struct();
...
{if ("" != null) return new ASTWhile(e1, e2);}
  ...
  final public Exp decl() throws ParseException {Token x; Exp e1, e2; ArrayList<ASTBinding> bindings = new ArrayList<ASTBinding>();
...
{if ("" != null) return new ASTPrint(e);}
  ...
  final public Exp println() throws ParseException {Exp e;
...
{if ("" != null) return new ASTPrintln(e);}
  ...
  final public Exp assign() throws ParseException {Exp e1,e2;
    e1 = logic();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return e1;}
  ...
  final public Exp logic() throws ParseException {Exp e1, e2;
    e1 = boolOP();
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return e1;}
  ...
  final public Exp boolOP() throws ParseException {Exp e1, e2;
    e1 = Expr();
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return e1;}
  ...
  final public Exp Fact() throws ParseException {Token x; Exp e,e1;ArrayList<Exp> args = new ArrayList<>();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case Num:{
...
{if ("" != null) return new ASTBool(Boolean.parseBoolean(x.image));}
      break;
      }
    case ID:{
      x = jj_consume_token(ID);
...
{if ("" != null) return new ASTFunCall(new ASTVar(x.image),args);}
        break;
        }
      default:
        jj_la1[14] = jj_gen;
{if ("" != null) return new ASTVar(x.image);}
      }
      break;
      }
    case MINUS:{
...
{if ("" != null) return new ASTInt(-(Integer.parseInt(x.image)));}
    ...
    case DEREFERENCE:{
      ...
      e = Fact();
{if ("" != null) return new ASTDereference(e);}
      break;
      }
    case NEW:{
      jj_consume_token(NEW);
      e = Fact();
{if ("" != null) return new ASTReference(e);}
      break;
      }
    case NEGATE:{
      jj_consume_token(NEGATE);
      e = Fact();
{if ("" != null) return new ASTBoolNegate(e);}
      break;
      }
    case STRING:{
      x = jj_consume_token(STRING);
{if ("" != null) return new ASTString(x.image);}
      break;
      }
    case LPAR:{
      jj_consume_token(LPAR);
...
{if ("" != null) return e;}
    ...
    case FN:{
      jj_consume_token(FN);
      jj_consume_token(LPAR);
ArrayList<FunArgs> params= new ArrayList<>();
    Exp body;
    Type type;
    Type retType;
      x = jj_consume_token(ID);
...
params.add(new FunArgs(x.image,type));
      ...
      retType = Type();
      jj_consume_token(END);
{if ("" != null) return new ASTFun(params,body,retType);}
      break;
      }
    default:
      jj_la1[16] = jj_gen;
  ...
  final public Type Type() throws ParseException {Token x;
    x = jj_consume_token(ID);
{if ("" != null) return ParsingType.valueOf (x.image.toUpperCase()).getType();}
    throw new Error("Missing return statement in function");
}
